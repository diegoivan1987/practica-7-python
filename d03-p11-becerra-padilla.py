...
def dibujomenu(em,e1,e2,e3,e4): #Esta funcion creara la ventana siempre que se necesite con colores
    ...
    #En la esquina mandara a imprimir los errores con parametros
        ...
        errorcatch=str(em);
        print(Fore.WHITE+Style.BRIGHT+Cursor.POS(3,16)+Back.LIGHTBLUE_EX+Style.BRIGHT+"Errores Menu: "+errorcatch, end="");
        errorcatch=str(e1);
        print(Fore.WHITE+Style.BRIGHT+Cursor.POS(3,14)+Back.LIGHTBLUE_EX+Style.BRIGHT+"Errores en Ej. 1: "+errorcatch, end="");
        errorcatch=str(e2);
        print(Fore.WHITE+Style.BRIGHT+Cursor.POS(35,14)+Back.LIGHTBLUE_EX+Style.BRIGHT+"Errores en Ej. 2: "+errorcatch, end="");
        errorcatch=str(e3);
        print(Fore.WHITE+Style.BRIGHT+Cursor.POS(3,15)+Back.LIGHTBLUE_EX+Style.BRIGHT+"Errores en Ej. 3: "+errorcatch, end="");
        errorcatch=str(e4);
        print(Fore.WHITE+Style.BRIGHT+Cursor.POS(35,15)+Back.LIGHTBLUE_EX+Style.BRIGHT+"Errores en Ej. 4: "+errorcatch, end="");
...
def dibujoej(errorcatch): #Esta funcion creara la ventana siempre que se necesite con colores
    ...
    if errorcatch== -1: 
        ...
        print(Fore.WHITE+Style.BRIGHT+Cursor.POS(3,15)+Back.LIGHTBLUE_EX+Style.BRIGHT+"Errores del Ejercicio : "+errorcatch, end="");
...
def menu():
    ...
    while opcion != 0: #Mientras la opcion no sea 0 para salir, seguira en el menu
        ...
        print(Fore.WHITE+Style.BRIGHT+Cursor.POS(3,9)+Style.BRIGHT+"-Ingrese 0 para salir:", end="");
...
print(Fore.WHITE+Style.BRIGHT+Cursor.POS(3,4)+Cursor.POS(3,5)+"becerra gonzalez diego ivan", end="");
print(Fore.WHITE+Style.BRIGHT+Cursor.POS(3,4)+Cursor.POS(3,6)+"padilla valdez gustavo", end="");
input();
os.system("cls");
