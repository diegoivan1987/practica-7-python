...
def cal_subsidio():
    ...
    if num_hijos > 0 and num_hijos < 53 :
        ...
        #si no ingresa un numero valido de hijos en edad escolar le pide que lo haga
            ...
            print("El numero que ingresaste de hijos no concuerda con los hijos que tiene");
            #guarda 1 si es viuda
            viuda = int(input("Si eres viuda ingresa 1, si no ingresa 0   "));
            #suma 20 si es viuda
            if viuda == 1:
    ...
    if num_hijos > 0 and num_hijos < 53 :
        ...
        if num_hijos_esc <= num_hijos : #Los hijos en edad escolar tienen que ser igual o menores a los hijos totales
...
def basquetbol():
    ...
    if anotados > 0 and fallados > 0: #Si los anoto y fallo al menos un tiro
        ...
        #imprime los tiros fallados y anotados
        print("\nDe los cuales anotaste", anotados, "tiros\n");
        print("\nY no anotaste", fallados, "tiros\n");
    ...
    #si no anoto tiros despliega ese mensaje
    if anotados <= 0:
        print("Si no anotaste nada, no pudiste haber hecho puntos");
        puntos = 0;
    #si anoto tiros, le pregunta cuantos puntos anoto    
    else:
        puntos = (int(input("¿Cuantos puntos anotaste?: ")));

        
    if puntos > anotados * 3 : #Si ingreso un numero no valido le dice que no
        print("No es posible esos puntos con los tiros que anotaste");
        ...
        else: #En otro caso muestra este mensaje
