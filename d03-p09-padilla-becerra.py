...
def bachoco():#determina el promedio de calidad de n-gallinas y calcula el precio del kg de huevo
    ...
    for i in aumento:
        opcionBachoco = str(input("\nIngresa 1 para ingresar los datos de una gallina y 2 para imprimir el precio por kg de huevo "));
            ...
            if opcionBachoco < 1 or opcionBachoco > 2 :#si esta fuera del rango
                ...
                for i2 in aumento2 :
                    ...
                    try:#si ingreso un numero
                        ...
                        for z in aumenton:
                        	if peso <= 0:
                        		print("No puede ser negativo o 0");
                        		peso=float(input("Ingresa el peso correctamente "));
                        		aumenton.append(0);
                        aumenton=[0];
                ...
                for i2 in aumento2 :
                    altura = str(input("Ingresa la altura de la gallina en cm "));
                    try:#si ingreso un numero
                        altura = float(altura);
                        for z in aumenton:
                        	if altura <= 0:
                ...
                aumento2 = [0];#se vuelve a vaciar la lista
                for i2 in aumento2 :
                    huevos = str(input("Ingresa el numero de huevos que pone (Solo enteros) "));
                    try:#si ingreso un numero
                        huevos = int(huevos);
                        for z in aumenton:
                        	if huevos<0 :
                        		print("No puede ser negativo");
                        		huevos=int(input("Ingresa los huevos que pone  "));
                        		aumenton.append(0);
                        aumenton=[0];
                    except:#si ingresa un caracter
                        print("Debes ingresar el dato usando el dato que se te pide");
                        aumento2.append(0);
                        
                calidad = (peso*altura)/huevos;#calcula la calidad de la gallina
                calidades.append(calidad); #guarda la calidad de la gallina
                ...
                aux=0 ;
                for x in calidades :#recorre la lista de calidad
                    sumatoria += calidades[aux];
                    aux +=1;
                if contador ==0:
                	promedio=0;
                else:
...
def diputados():
        ...
        for i in aumento :#se repetira hasta llegar a 1, al llegar a una opcion o validacion i se inicia en 0
                ...
                try :#si ingresa un numero, lo ejecuta
                        ...
                        if opcion < 0 or opcion > 2 :#si esta fuera del rango o es negativo
                            ...
                            if votos_disp == 0:#Si ya no hay diputados que puedan votar
                                 pass; #No agregara nada, y el for terminara
                            elif opcion == 1 and votos_disp != 0:#Si elige la opcion 1 y todavia se puede votar
                                favor += 1; #Se le añadira 1 a favor
                                aumento.append(0);
                                votos_disp -= 1;
                            elif opcion == 0 and votos_disp != 0: #En la opcion 0 y 1 se repite lo mismo que lo anterior
                                contra += 1;
                                aumento.append(0);
                                votos_disp -= 1;
                            elif opcion == 2 or votos_disp == 0: #sale
        ...
        print("El promedio de los votos abstenidos fue de %" , promabst , "Con un total de ", abst);
